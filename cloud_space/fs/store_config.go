...
type StoreSpaceConfig struct {
	...
	Index      uint64                        `xorm:"int 'index'"`             //存储空间索引
...
/*
	添加一个共享目录
*/
func (this *StoreSpaceConfig) Add(vnodeIndex uint64, vnodeId virtual_node.AddressNetExtend, dbAbsPath string, index uint64) error {
