...
*/
func AddFileindexToSelf(fi *FileIndex) error {
	//	//合并FileUser
	...
	fiLocal, err := FindFileindexToSelf(*fi.Hash)
	if fiLocal != nil {
...
*/
func FindFileindexToSelf(name virtual_node.AddressNetExtend) (*FileIndex, error) {
