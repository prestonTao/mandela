...
// 	获取本节点钱包中收款地址
// */
// func GetWalletAddr(c engine.Controller, msg engine.Packet) {
...
// 	获取本节点钱包中收款地址 返回
// */
// func GetWalletAddr_recv(c engine.Controller, msg engine.Packet) {
...
// 		return
// 	}
// 	flood.ResponseWait(mc.CLASS_getWalletAddr, message.Body.Hash.B58String(), message.Body.Content)
// }
