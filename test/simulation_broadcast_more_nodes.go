...
// 			Nodes: make([]nodeStore.AddressNet, 0),
// 		}
// 		nodes = append(nodes, addrOne)
// 		// fmt.Println(addrOne.B58String())
// 	}

// 	for index := 0; index < len(nodes); index++ {

// 		idsm := nodeStore.NewIds(NodeOne.Self, gconfig.NodeIDLevel)
// 		for i, _ := range nodes {
// 			if i == index {
// 				continue
// 			}
...
func SimulateMoreNodes() []*NodeOne {
	...
	for n := 0; n < len(ids); n++ {
		...
		fmt.Println(n+1, "本节点为", ids[n].B58String())
		index := n
